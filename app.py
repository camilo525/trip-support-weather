...
def generate_client_text(wx, icao, type="dep"):
    ...
    if type == "dep":
        if is_critical:
            ...
            return f"Análisis meteorológico para su salida de {icao} indica condiciones ideales. El equipo de operaciones analiza las condiciones y confirma un proceso sin inconvenientes para su día de viaje."
    else:
        if is_critical:
            ...
            return f"El terminal forecast para su llegada a {icao} permanece favorable. El equipo de operaciones analiza las condiciones y estamos reportando una llegada confortable conforme a lo programado."
        ...
        try:
            ...
            fig.update_layout(
                geo=dict(
                    ...
                    bgcolor="rgba(0,0,0,0)", showocean=True, oceancolor="#050505"
                ),
